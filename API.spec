...
paddle.fluid.layers.StaticRNNMemoryLink.__init__ ArgSpec(args=['self', 'init', 'pre_mem', 'mem'], varargs=None, keywords=None, defaults=(None,))
...
paddle.fluid.layers.all_gather ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
